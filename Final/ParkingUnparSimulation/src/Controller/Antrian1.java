 ...
 *
 */
public class Antrian1 extends Machine {
    ...
    private void generateUang() {
        String[] uang = this.of.getUang();
        for (int i = 0; i < rangeData; i++) {
            String temp = of.getUang()[i];
          
            this.uang[i] = Integer.parseInt(temp);
        }
    }
    ...
    public void calculateArrival() {
        ...
        int randArrival = Integer.parseInt(of.getArival()[i]);
    ...
    private String finalCount(){
        ...
        res += "Complete in "+this.completion[this.completion.length-1]+" sec";
